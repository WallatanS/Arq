...
class ConstrutorCadastro extends StatefulWidget {
  //final int id;
  final int opcao;
  const ConstrutorCadastro(this.opcao,{super.key});

  @override
  State<ConstrutorCadastro> createState() => _ConstrutorCadastroState();
}

class _ConstrutorCadastroState extends State<ConstrutorCadastro> {
